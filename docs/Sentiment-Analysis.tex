...
\title{Naslov seminarskog rada\\ \small{Seminarski rad u okviru kursa\\Računarska inteligencija\\ Matematički fakultet}}
...
Reference koje se koriste u ovom tekstu zadate su u datoteci {\em Sentiment-Analysis.bib}. Prevođenje u pdf format u Linux okruženju može se uraditi na sledeći način:
\begin{verbatim}
